...
y = rxns,
col = alpha(c(rep(cbp1[3], length(rxns)/4),
              rep(cbp1[4], length(rxns)/4),
              rep(cbp1[5], length(rxns)/4),
              rep(cbp1[6], length(rxns)/4)), alphaVal),
pch = pch
)
...
y = mets, col = alpha(c(rep(cbp1[3], length(mets)/4),
                        ...
                        rep(cbp1[6], length(mets)/4)), alphaVal),
pch = pch
)
...
y = genes, col = alpha(c(rep(cbp1[3], length(genes)/4),
                         ...
                         rep(cbp1[6], length(genes)/4)), alphaVal),
pch = pch
)
