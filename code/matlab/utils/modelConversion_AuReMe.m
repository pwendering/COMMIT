...
for i=1:numel(habitats)
    ...
    % Model directory
    AuReMeModelDir = fullfile('/srv/wendering/AuReMe-models',habitats{i});
    ModelWorkspace = fullfile('/stud/wendering/Masterthesis/DATA/models_AuReMe',...
    habitats{i}, strcat(habitats{i}, '_models.mat'));
    DraftWorkspace = fullfile('/stud/wendering/Masterthesis/DATA/models_AuReMe',...
