function changed_model = removeDuplicateRxnsReactionPairs(model, database, verbose)
...
%% Check user input
if nargin == 0
    error('USAGE: removeDuplicateRxnsReactionPairs(model, database, verbose(optional)')
elseif nargin == 1
