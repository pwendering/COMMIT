C% find exchanged metabolites between the OTUs

habitat = 'Root';
experiment = 'Bulgarelli';
subFolder = 'all';

% file containing the reduced KEGG pathway file
pathwayFile = '/net/calc1/srv/wendering/kegg/pathway/pathway_compounds_red.csv';

% file containing the extended KEGG brite br08001 file
...
%     habitat, [experiment, '_noCarveMe']);

modelWorkspace = ...
    fullfile('/stud/wendering/Masterthesis/DATA/Gap-filling/iterative',...
    habitat, subFolder, experiment);

otutab = readAbundancesFromFile(fullfile('/stud/wendering/Masterthesis/DATA/Abundances',...
    habitat, experiment, 'otutab.txt'));
...
writetable(cell2table(brite_exchange,...
    'RowNames', tax_classes, 'VariableNames', tax_classes),...
    ['/stud/wendering/Masterthesis/FIGURES/exchanged_metabolites/graph/',...
    subFolder, '_brite_exchanged_',experiment, '.txt'],...
    'WriteVariableNames', true, 'WriteRowNames', true,...
    'Delimiter', '\t')
...
writetable(array2table([otutab.abundances, cellfun(@numel,imported_per_model)],...
    ...
    ['/stud/wendering/Masterthesis/FIGURES/exchanged_metabolites/',...
    subFolder, '_imported_vs_abundance_',experiment, '.txt'],...
    'WriteVariableNames', true, 'WriteRowNames', true,...
    'Delimiter', '\t')
...
writetable(array2table(exchange_mt, 'VariableNames', tax_classes),...
    ['/stud/wendering/Masterthesis/FIGURES/exchanged_metabolites/graph/',...
    [habitat, '_', subFolder], '_exchanged_metabolites_',experiment, '.txt'],...
